...
ENV ECS_GEN_RELEASE 0.3.3
RUN curl -OL https://github.com/hackgt/ecs-gen/releases/download/$ECS_GEN_RELEASE/ecs-gen-linux-amd64.zip && unzip ecs-gen-linux-amd64.zip && cp ecs-gen-linux-amd64 /usr/local/bin/ecs-gen
